...
#SBATCH --output=log/EVAL/AllBloks_%j.out
#SBATCH  --error=log/EVAL/AllBloks_%j.err
...
python3 /homes/tsommariva/neumeta/neumeta/testBloks.py --config neumeta/config/cifar100/Cifar100_resnet56_myConf_Iterative.yaml \
    --resume_from "/work/tesi_tsommariva/experiments/AaITERATIVE/WithEval_v2_OnlyLast_OnlyMod4_resmlpDictXL_8simultaneusBlocks_50_4AccumulationSteps_warmup_cosine_20e" \
