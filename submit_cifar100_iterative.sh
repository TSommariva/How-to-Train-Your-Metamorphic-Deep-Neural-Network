...
#SBATCH --output=log/ResnetXL/updatedKeys_OnlyMod4_AllSimBlock_%j.out
#SBATCH  --error=log/ResnetXL/updatedKeys_OnlyMod4_AllSimBlock_%j.err
...
python3 /homes/tsommariva/neumeta/neumeta/train_cifar100_iterative.py --config neumeta/config/cifar100/Cifar100_resnet56_myConf_Iterative.yaml \
    --experiment.simul_blocks=8 \
    --resume_from "/work/tesi_tsommariva/experiments/AaITERATIVE/HybridTraining_OnlyMod4_resmlpDictXL_8simultaneusBlocks_50_4AccumulationSteps_warmup_cosine_20e/cifar100_nerf_best.pth" \
