...
#SBATCH --job-name=fin150         
#SBATCH --output=log/AaDDP/8Blocks_150e_4AccumulationSteps_BottomUp_Full_FINISH.out               
#SBATCH --error=log/AaDDP/8Blocks_150e_4AccumulationSteps_BottomUp_Full_FINISH.err                
...
mpirun -np $WORLD_SIZE -x MASTER_ADDR=$MASTER_ADDR -x MASTER_PORT=$MASTER_PORT \
    ...
    --resume_from "experiments/AaITERATIVE/8Blocks_150e_4AccumulationSteps_bottomUp:True_Iterative:True_Full/block3/cifar100_nerf_best.pth"