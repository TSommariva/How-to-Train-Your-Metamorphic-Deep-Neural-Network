...
python3 /homes/tsommariva/neumeta/neumeta/train_cifar100_iterative.py --config neumeta/config/cifar100/Cifar100_resnet56_myConf_Iterative.yaml \
    #--resume_from "/work/tesi_tsommariva/experiments/AaITERATIVE/SwitchableBN_resmlpDict_8simultaneusBlocks_50_4AccumulationSteps_warmup_cosine_20e/nerf_block1.pth" \
