...
case $SLURM_ARRAY_TASK_ID in
    0) BATCH_ACCUM=4; ARCH_ACCUM=1 ; LR=0.00085 ; ETA_MIN=8e-5; RESUME_FROM="/work/tesi_tsommariva/experiments/AaITERATIVE/SingleBlock_CustomInit_BatchAccumulationSteps:4_ArchAccumulationSteps:1_lr:0.00085/fineTuning/cifar100_nerf_best.pth";;
    1) BATCH_ACCUM=1; ARCH_ACCUM=1 ; LR=3e-4 ; ETA_MIN=3e-5; RESUME_FROM="/work/tesi_tsommariva/experiments/AaITERATIVE/SingleBlock_CustomInit_BatchAccumulationSteps:1_ArchAccumulationSteps:1_lr:3e-4/fineTuning/cifar100_nerf_best.pth";;
