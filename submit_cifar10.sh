...
#SBATCH --job-name=NeRF64            # Set the job name (optional, default is "slurm-[jobid]")
#SBATCH --output=log/AlreadySmoothed_hiddenDim64_ce1e2_rec1_reg1e-3_elu_600e_T200_V2.out               # Redirect output to this file (%j will expand to jobID, optional, default is "slurm-[jobid].out")
#SBATCH --error=log/AlreadySmoothed_hiddenDim64_ce1e2_rec1_reg1e-3_elu_600e_T200_V2.err                 # Redirect errors to this file (optional, default is the same as --output)
