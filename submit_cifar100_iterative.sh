...
#SBATCH --job-name=NoInit
#SBATCH --output=log/AaPaper/XL/NoInit_Finish_%j.out
#SBATCH  --error=log/AaPaper/XL/NoInit_Finish_%j.err
...
python3 /homes/tsommariva/neumeta/neumeta/train_cifar100_iterative.py --config neumeta/config/cifar100/Cifar100_resnet56_myConf_Iterative.yaml \
    --resume_from "/work/tesi_tsommariva/experiments/Paper/RXL_lastBlock_resmlpDict_50e_skipInit_StartBlock1_CustmInit:False_4AccumulationSteps/nerf_best.pth" \
