...
#SBATCH --output=log/ResnetXL/updatedKeys_OnlyMod4_1SimBlock_%j.out
#SBATCH  --error=log/ResnetXL/updatedKeys_OnlyMod4_1SimBlock_%j.err
...
python3 /homes/tsommariva/neumeta/neumeta/train_cifar100_iterative.py --config neumeta/config/cifar100/Cifar100_resnet56_myConf_Iterative.yaml \
    #--resume_from "/work/tesi_tsommariva/experiments/AaITERATIVE/HybridTraining_evenOnly_resmlpDictXL_1simultaneusBlocks_50_4AccumulationSteps_warmup_cosine_20e/cifar100_nerf_last.pth" \
