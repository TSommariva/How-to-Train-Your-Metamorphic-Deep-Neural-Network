...
#SBATCH --job-name=iterTd            # Set the job name (optional, default is "slurm-[jobid]")
#SBATCH --output=log/AaITERATIVE/8Blocks_80e_3AccumulationSteps_BottomUp_5e-4lr.out               # Redirect output to this file (%j will expand to jobID, optional, default is "slurm-[jobid].out")
#SBATCH --error=log/AaITERATIVE/8Blocks_80e_3AccumulationSteps_BottomUp_5e-4lr.err                 # Redirect errors to this file (optional, default is the same as --output)
